  ...
  async function sendOrder() {
    ...
    try {
      ...
      setOrder({
        ...
        items: currentOrder?.id === order.id ? [...currentOrder.items, ...newItems] : newItems,
      });
      clearCart();
      onClose();
    } catch (err) {
