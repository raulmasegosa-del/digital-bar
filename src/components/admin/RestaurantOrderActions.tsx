...
const actionsByStatus: Partial<Record<OrderStatus, Action[]>> = {
  pending: [{ label: "Preparando", status: "preparing", tone: "border-blue-500/30 bg-blue-500/10 text-blue-300 hover:border-blue-400/50 hover:bg-blue-500/15" }, { label: "Listo", status: "ready", tone: "border-emerald-500/30 bg-emerald-500/10 text-emerald-300 hover:border-emerald-400/50 hover:bg-emerald-400/15" }],
  preparing: [{ label: "Listo", status: "ready", tone: "border-emerald-500/30 bg-emerald-500/10 text-emerald-300 hover:border-emerald-400/50 hover:bg-emerald-500/15" }, { label: "Recibido", status: "pending", tone: "border-yellow-500/30 bg-yellow-500/10 text-yellow-300 hover:border-yellow-400/50 hover:bg-yellow-500/15" }],
  ready: [{ label: "Servido", status: "served", tone: "border-emerald-500/30 bg-emerald-500/10 text-emerald-300 hover:border-emerald-400/50 hover:bg-emerald-500/15" }, { label: "Preparando", status: "preparing", tone: "border-blue-500/30 bg-blue-500/10 text-blue-300 hover:border-blue-400/50 hover:bg-blue-500/15" }],
