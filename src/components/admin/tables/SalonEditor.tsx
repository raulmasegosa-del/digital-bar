...
export default function SalonEditor({slug,restaurantId,tables}:Props){
 ...
 <div className="relative min-h-[620px] touch-none overflow-hidden bg-[radial-gradient(circle_at_1px_1px,#3f3f46_1px,transparent_1px)] [background-size:24px_24px]" onPointerMove={move} onPointerUp={stopDragging} onPointerCancel={stopDragging}>
   ...
   {editing&&<div className="absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full border border-zinc-700 bg-zinc-950/90 px-4 py-2 text-xs text-zinc-400">Arrastra mesas y barra con ratón o dedo · pulsa la barra para girarla 90° · después guarda</div>}
 </div></section>;
}
