...
import FindProductImagesButton from "@/components/admin/FindProductImagesButton";
  ...
  return (
    <main className="min-h-screen bg-[#11100f] text-white">
      <div className="w-full px-6 py-8">
        <div className="mb-8 flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-400">
              Gestiona la carta de {restaurant.name}, sus precios y disponibilidad.
            </p>
          </div>

          <div className="flex flex-col gap-2 sm:flex-row">
            <FindProductImagesButton slug={slug} />
        ...
        <ProductTable items={products} slug={slug} />
      </div>
    </main>
  );
}
